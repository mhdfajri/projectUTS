...
ALTER TABLE film ADD PRIMARY KEY (`no`);

ALTER TABLE user ADD PRIMARY KEY (`no`);

ALTER TABLE film MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

ALTER TABLE user MODIFY `no` int(120) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
